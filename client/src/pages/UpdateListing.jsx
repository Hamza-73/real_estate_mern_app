...
export default function updateListing() {
  ...
  const handleChange = (e) => {
    if (e.target.id == 'sale' || e.target.ud == 'rent') {
      setFormData({
        ...formData,
        type: e.target.id,
      })
  ...
  const handleSubmitListing = async (e) => {
    e.preventDefault();
    try {
      if (formData.imageUrls.length < 1) return setError("Upload atleast one image to create listing")
        ...
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex gap-6 flex-wrap'>
            <div className='flex gap-2'>
              <input type='checkbox' id='sale' className='w-5' value={formData.type} checked={formData.type === "sale"} onChange={handleChange} />
              <span>Sell</span>
            </div>
            <div className='flex gap-2'>
              <input type='checkbox' id='rent' className='w-5' value={formData.type} checked={formData.type === "rent"} onChange={handleChange} />
              <span>Rent</span>
            </div>
            <div className='flex gap-2'>
              <input type='checkbox' id='parking' className='w-5' value={formData.parking} onChange={handleChange} />
              <span>Parking spot</span>
            </div>
            <div className='flex gap-2'>
              <input type='checkbox' id='furnished' className='w-5' value={formData.furnished} onChange={handleChange} />
              <span>Furnished</span>
            </div>
            <div className='flex gap-2'>
              <input type='checkbox' id='offer' className='w-5' value={formData.offer} onChange={handleChange} />
              <span>Offer</span>
            </div>
          </div>
